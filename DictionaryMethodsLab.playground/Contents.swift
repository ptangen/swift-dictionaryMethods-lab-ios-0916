 ...
 */
for types in starWarsCharacters.keys {
    print(types)
}
 ...
 */
let typeCount = starWarsCharacters.count
print(typeCount)
 ...
 */
let result1 = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi")
 ...
 */
let result2 = starWarsCharacters.removeValueForKey("Bounty Hunters")
